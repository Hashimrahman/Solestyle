      ...
      <div className="min-h-screen bg-gray-100 py-10">
        ...
        <div className="max-w-4xl mx-auto">
          {orders.map((order) => {
            ...
            return (
              <div key={order.orderId} className="bg-white p-6 rounded-lg shadow-lg mb-6">
                <h3 className="text-xl font-semibold mb-2">Order ID: {order.orderId}</h3>
                <p className="text-gray-500 mb-2">Order Date: {new Date(order.orderDate).toLocaleDateString()}</p>
        ...
        <div className="w-full flex justify-center">
          <button className="bg-blue-400 px-16 py-4 rounded-3xl text-lg" onClick={() => navigate('/')}>
            Go to Home
          </button>
        </div>
      </div>
