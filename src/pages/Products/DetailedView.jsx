...
//     setCount(newQuantity); // Update the count immediately in the UI
...
//   const addToCartWithUpdatedQuantity = () => {
//     const updatedProduct = { ...product, quantity: count };
//     handleAddToCart(updatedProduct); // Pass the updated quantity to the cart
//   };
...
//               </div>
//               <img src={product.image} alt={product.name} className="h-4/5 rounded-md" />
//             </div>
//           </div>
...
//                     onClick={addToCartWithUpdatedQuantity} // Call the updated function
//                   >
//                     Add to Cart
//                   </button>
//                 </div>
    ...
    <div className="mt-20">
      <div className="mx-8 my-28">
        <div className="w-full flex md:p-4 flex-wrap">
          ...
          <div className="h-auto w-full md:w-1/2 md:p-4">
            <div className="flex flex-col justify-start md:p-6 gap-4">
              <h1 className="text-3xl hidden md:inline-block">{product.name}</h1>
              <h4 className="text-md uppercase opacity-50 font-bold">{product.brand}</h4>
              <h2 className="text-xl">{product.price} ₹</h2>
              <h3 className="text-justify">{product.description}</h3>
              <div>
                <p>Size :</p>
